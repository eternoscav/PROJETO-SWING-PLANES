...
public class PlayerManager : MonoBehaviour 
{
	...
	void OnTriggerEnter (Collider other)
	{
		...
		else if (other.tag == "PowerUps")
		{
			...
			switch (other.transform.name)
			{
				...
				audio.PlayOneShot(Audio_Speed);
					break;
				
				case "Shield":
					RaiseShield();
				StartCoroutine(timeShield());
				audio.PlayOneShot(Audio_Shield);
					break;
	...
	IEnumerator LaunchSonicWave()
	{
		...
		StartCoroutine(MoveToPosition(sonicWave.transform, new Vector3(75, 0, -5), 1.25f, false));
	...
	IEnumerator SinkEffects()
	{
        ...
        LevelGenerator.Instance.StartCoroutine("StopScrolling", 0.5f);
